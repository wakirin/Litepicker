...
let proxyOptions = new Proxy(defaultOptions, optionTrigger);

let pickerOptions = document.getElementById('picker-options');
let picker = new Litepicker(proxyOptions);
...
const createSelectContainer = (el, opt, values) => {
  ...
  let etc = document.createElement('option');
  etc.text = 'etc ...';
  etc.disabled = true;
